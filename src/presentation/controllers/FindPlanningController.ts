...
import { TFindPlanning, TRoute, Response } from '@/presentation/protocols'
import { BadRequestError } from '@/presentation/exceptions'
import { InvalidParam } from '@/domain/exceptions'

export class FindPlanningController {
  /**
   * @swagger
   * /planning:
   *   get:
  ...
  public static async handle(req: TRoute.handleParams<TFindPlanning.Request.body, TFindPlanning.Request.params, TFindPlanning.Request.query>): Promise<Response<TFindPlanning.Response>> {
    try {
      ...
      const findPlanning = new FindPlanning(new PlanningQueryRepository())
